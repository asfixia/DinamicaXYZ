...
def raster2png(raster_file, color_table, out_file_name, raster_band=1,
               discrete=True):  # color_file, out_file_name, raster_band=1, discrete=True):
    ...
    classification_values = list(color_table.keys())
                    ...
                    if index == 0:
                        ...
                        r = color_table[classification_values[index - 1]][0] + (
                                    values[pos] - classification_values[index - 1]) * (
                                        ...
                                        classification_values[index] - classification_values[index - 1])
...
def Usage():
    ...
    "Usage:"
    print
    argv[0] + ' [-exact_color_entry|-nearest_color_entry] [-band=1] data_file color_file output_file'
    exit()
